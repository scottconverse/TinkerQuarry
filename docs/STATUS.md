...
> a cloud-optional *decision* exist), the **7 bundled libraries**, the **manual-orient override**, a real
> user-invoked **Explain mode**, a tool-using **agent loop**, and the **rich iteration log**. Recovery
