...
| **Dropped/hidden from Studio** | Share links / remixable public links; public web telemetry as shipped; cloud-first setup; the editor-first default layout; multi-file-project emphasis (de-emphasized for non-coders). |
...
> glue 19/19, engine 1,590 passing / 0 failing of ~1,691 collected** (the round-1 env/profile
> failures were fixed in round 2). The "not re-executed here" caveat above is historical.
