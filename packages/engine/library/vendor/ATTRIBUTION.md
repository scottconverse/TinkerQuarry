...
| tq-threads | https://github.com/scottconverse/tq-threads | `73aa7c0a1ed741bd09dc6747505f6a85ad1421ae` (post-`v0.2.0` review fixes) | MIT | Clean-room printable OpenSCAD thread library used as the GPLv2-compatible replacement for Dan Kirshner / rcolyer `threads.scad`. Full upstream tree, excluding `.git`. |
